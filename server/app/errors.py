...
CODIGOS = {
    ...
    "reauth_required": "a operação pede a chave de administração redigitada (ou Bearer)",
    "key_exists": "já existe uma chave com esse id ou nome",
    "key_not_found": "a chave não existe",
    "key_ambiguous": "há mais de uma chave de admin com esse id: informe fp",
    "last_admin_key": "é a última chave de admin: crie outra antes",
    "invalid_key_id": "id de chave de admin fora do formato",
    "confirm_required": "revogar a chave da própria sessão pede confirmação",
